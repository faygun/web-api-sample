...
namespace TeaCounter.Service
{
    public class SwaggerConfig
    {
                ...
                .EnableSwagger(c =>
                    {
                        ...
                        //
                        c.SingleApiVersion("v1", "TeaCounter.Service");
        ...
        public class RemoveTagPrefixOperationFilter : IOperationFilter
        {
            ...
            {
                string prefixToCheck = apiDescription.ActionDescriptor.ControllerDescriptor.ControllerName + "_";
                if (operation.operationId.StartsWith(prefixToCheck))
                {
                    operation.operationId = operation.operationId.Remove(0, prefixToCheck.Length);
                }
            }
        }
